...
Check for and remove non-consenting participants. Initial consent (Q4) 1 = Yes, 2 = Full info sheet 3 = No
Full info sheet (Q19) 1 = Yes, 2 = No

```{r}
table(pers$q4, useNA="ifany") #647 yes, 5 no, 8 full info, 1 NA
table(pers$q19, useNA="ifany") #7 further yes

pers <- filter(pers, q4==1|q19==1)
```
...
186 not completed, leaving n = 468.
